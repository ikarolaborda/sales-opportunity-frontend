const ptBR = {
  ...
  entities: {
    ...
    userType: {
        ...
        exporterFileName: 'UserType_exportados',
        list: {
          menu: 'Tipos de Usuários',
          title: 'Tipos de Usuários',
        },
        create: {
          success: 'Tipo de Usuário salvo com sucesso',
        },
        update: {
          success: 'Tipo de Usuário salvo com sucesso',
        },
        ...
        destroyAll: {
          success: 'Tipos de Usuários deletado com sucesso',
        },
        edit: {
        ...
        importer: {
          title: 'Importar Tipos de Usuários',
          fileName: 'userType_template_importacao',
          hint:
            'Arquivos/Imagens devem ser as URLs dos arquivos, separados por espaço. Relacionamentos devem ser os IDs separados por espaço.',
        },
      },
    ...
    salesOpportunities: {
        ...
        menu: 'Oportunidades de Venda',
        exporterFileName: 'SalesOpportunities_exportados',
        list: {
          menu: 'Oportunidades de Venda',
          title: 'Oportunidades de Venda',
        },
        create: {
          success: 'Oportunidade de Venda salva com sucesso',
        },
        update: {
          success: 'Oportunidade de Venda salva com sucesso',
        },
        destroy: {
          success: 'Oportunidade de Venda deletada com sucesso',
        },
        destroyAll: {
          success: 'Oportunidades de Vendas deletadas com sucesso',
        },
        edit: {
          title: 'Editar Oportunidade de Venda',
        },
        fields: {
          id: 'Id',
          'sellerId': 'Vendedor',
        ...
        view: {
          title: 'Visualizar Oportunidades de Vendas',
        },
        importer: {
          title: 'Importar Oportunidade de Venda',
          fileName: 'salesOpportunities_template_importacao',
          hint:
            'Arquivos/Imagens devem ser as URLs dos arquivos, separados por espaço. Relacionamentos devem ser os IDs separados por espaço.',
        },
      },
