const en = {
  ...
  entities: {
    ...
    userType: {
        ...
        label: 'User Types',
        menu: 'User Types',
        exporterFileName: 'userType_export',
        list: {
          menu: 'User Types',
          title: 'User Types',
        },
        create: {
          success: 'User Type successfully saved',
        },
        update: {
          success: 'User Type successfully saved',
        },
        destroy: {
          success: 'UserType successfully deleted',
        },
        destroyAll: {
          success: 'UserType(s) successfully deleted',
        },
        edit: {
          title: 'Edit UserType',
        },
    ...
    salesOpportunities: {
        ...
        menu: 'Sales Opportunities',
        exporterFileName: 'salesOpportunities_export',
        list: {
          menu: 'Sales Opportunities',
          title: 'Sales Opportunities',
        },
        create: {
          success: 'Sales Opportunity successfully saved',
        },
        update: {
          success: 'Sales Opportunity successfully saved',
        },
        destroy: {
          success: 'Sales Opportunity successfully deleted',
        },
        destroyAll: {
          success: 'Sales Opportunities(s) successfully deleted',
        },
        edit: {
        ...
        importer: {
          title: 'Import Sales Opportunities',
