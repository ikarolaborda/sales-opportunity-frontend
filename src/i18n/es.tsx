const es = {
  ...
  entities: {
    ...
    userType: {
        ...
        label: 'UserTypes',
        menu: 'UserTypes',
        exporterFileName: 'exportacion_userType',
        list: {
          menu: 'UserTypes',
          title: 'UserTypes',
        },
        create: {
          success: 'UserType guardado con éxito',
        },
        update: {
          success: 'UserType guardado con éxito',
        },
        destroy: {
          success: 'UserType eliminado con éxito',
        },
        destroyAll: {
          success: 'UserType(s) eliminado con éxito',
        },
        edit: {
          title: 'Editar UserType',
        },
        fields: {
          id: 'Id',
          'userId': 'UserId',
        ...
        importer: {
          title: 'Importar UserTypes',
          fileName: 'userType_import_template',
          hint:
            'Las columnas Archivos/Imágenes deben ser las URL de los archivos separados por espacio.',
        },
      },
    ...
    salesOpportunities: {
        ...
        label: 'SalesOpportunities',
        menu: 'SalesOpportunities',
        exporterFileName: 'exportacion_salesOpportunities',
        list: {
          menu: 'SalesOpportunities',
          title: 'SalesOpportunities',
        },
        create: {
          success: 'SalesOpportunities guardado con éxito',
        },
        update: {
          success: 'SalesOpportunities guardado con éxito',
        },
        destroy: {
          success: 'SalesOpportunities eliminado con éxito',
        },
        destroyAll: {
          success: 'SalesOpportunities(s) eliminado con éxito',
        },
        edit: {
          title: 'Editar SalesOpportunities',
        },
        fields: {
          id: 'Id',
          'sellerId': 'SellerId',
        ...
        new: {
          title: 'Nuevo SalesOpportunities',
        },
        view: {
          title: 'Ver SalesOpportunities',
        },
        importer: {
          title: 'Importar SalesOpportunities',
          fileName: 'salesOpportunities_import_template',
          hint:
            'Las columnas Archivos/Imágenes deben ser las URL de los archivos separados por espacio.',
        },
      },
